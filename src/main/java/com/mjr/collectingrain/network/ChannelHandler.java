...
public class ChannelHandler extends FMLIndexedMessageToMessageCodec<IPacket> {
	...
	public static ChannelHandler init() {
		...
		channelHandler.channels = NetworkRegistry.INSTANCE.newChannel(CollectingRain.MODID, channelHandler, new PacketHandler());
	...
	public void sendToAllAround(IPacket message, NetworkRegistry.TargetPoint point) {
		try {
			...
			MessageUtilities.fatalErrorMessageToLog(CollectingRain.MODID, "Forge error when sending network packet to nearby players - this is not a Galacticraft bug, does another mod make fake players?");
			e.printStackTrace();
		}
	}
	...
	public void sendToDimension(IPacket message, int dimensionID) {
		try {
			...
			MessageUtilities.fatalErrorMessageToLog(CollectingRain.MODID, "Forge error when sending network packet to all players in dimension - this is not a Galacticraft bug, does another mod make fake players?");
			e.printStackTrace();
		}
	}
