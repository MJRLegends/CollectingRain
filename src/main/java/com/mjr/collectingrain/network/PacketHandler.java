...
import com.mjr.mjrlegendslib.MJRLegendsLib;
...
public class PacketHandler extends SimpleChannelInboundHandler<IPacket> {
	...
	protected void channelRead0(ChannelHandlerContext ctx, IPacket msg) throws Exception {
		...
		EntityPlayer player = MJRLegendsLib.proxy.getPlayerFromNetHandler(netHandler);
	...
	public static void setLivePacketCount(int livePacketCount) {
		PacketHandler.livePacketCount = livePacketCount;
	}
