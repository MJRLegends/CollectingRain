...
public class CapabilityStatsClientHandler {
	...
	public static Capability<IStatsClientCapability> STATS_CLIENT_CAPABILITY = null;

	public static final ResourceLocation PLAYER_CLIENT_PROP = new ResourceLocation(CollectingRain.MODID, "player_stats_client");
